      ...
      <div class="container">
        <div class="md-layout">
          <div class="md-layout-item">
            <h1 class="title">貼り込み資料画像検索プロトタイプ</h1>
            <br />
            ...
            >
              ...
              <h5 class="description">
                ...
                <a href="https://iiif.dl.itc.u-tokyo.ac.jp/repo/s/tanaka"
                  >田中芳男・博物学コレクション</a
                >の資料と、国立国会図書館デジタルコレクションで公開されている
                <a href="http://dl.ndl.go.jp/info:ndljp/pid/2610716">張交帖</a
                >を対象として、貼り込まれた資料単位での画像検索が可能なプロトタイプです。2019年1月末時点において、99帖、13,069コマ、34,746件の貼り込み資料が検索対象となっています。
              </h5>
              <h5 class="description">
                ...
                <a href="https://kunshujo.dl.itc.u-tokyo.ac.jp/"
                  >電子展示『&#25411;拾帖』</a
                >で公開されている貼り込み資料2,645件をモデルのファインチューニングに利用しています。詳細については、
                <a
                  href="https://docs.google.com/presentation/d/1sfb57LXGQSNgJEvaqQUsjzImA6hoVBFBHyban4deYGA/edit?usp=sharing"
                  >こちらの資料</a
                >をご確認ください。機械的な抽出処理を行っているため、
                <b
                  >貼り込み資料の抽出漏れ、および抽出誤りが含まれている点にご注意ください</b
                >。
              </h5>
              <h5 class="description">
